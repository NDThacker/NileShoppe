...
import { handleSellerLogin, setMessageAction } from '../../actions'
...
class Login extends Component {
    ...
    handleSubmit = (e) => {
        ...
        this.setState({}, () => {
            handleSellerLogin(this.props.dispatch, postData).then(
                status => {
                    let localState = this.state
                    ...
                    <div className='form-container faint-border col-xl-5 col-md-8 col-sm-12 col-xs-12 mt-5'>
                        <div>
                            <form className='col' onSubmit={this.handleSubmit}>
                                <Headline6 className='text-center mb-5'>Sign In as Seller</Headline6>
                        ...
                        <div>
                            ...
                            <Link to='/nile/seller/signup'><Subtitle2 className='text-center'>Create an acoount</Subtitle2></Link>
                        </div>
                    </div>
                </div>
                {
